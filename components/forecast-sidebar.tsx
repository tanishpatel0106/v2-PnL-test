...
export function ForecastSidebar({ onSelectionChange, onConfirm }: ForecastSidebarProps) {
  ...
  return (
    <div className="fixed left-4 top-28 bottom-4 w-80 z-50 bg-gradient-to-br from-slate-50 to-white rounded-xl shadow-2xl border border-gray-200/50 flex flex-col backdrop-blur-sm">
      <div className="p-6 border-b border-gray-200/50">
        <h2 className="text-lg font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">📈 Forecast Config</h2>
      </div>
